...
public class EventAdminController {
    ...
    @GetMapping
    public List<EventFullDto> getEventByAdmin(@RequestParam(required = false) List<Long> users,
        ...
        log.info("Вызван метод getEventByAdmin() в EventAdminController.");
    ...
    public EventFullDto updateEventByAdmin(@PathVariable @Positive Long eventId,
        ...
        log.info("Вызван метод updateEventByAdmin() в EventAdminController для события с id {}.", eventId);
    ...
    public EventFullDto rejectEvent(@PathVariable @Positive Long eventId) {
        log.info("Вызван метод rejectEvent() в EventAdminController для события с id {}.", eventId);
