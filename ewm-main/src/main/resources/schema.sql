...
(
    ...
    CONSTRAINT reaction CHECK (reaction IN ('LIKE', 'DISLIKE')),
    CONSTRAINT ratings_event FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE,
    CONSTRAINT ratings_user FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);